...
from schedules.schemas import ScheduleCreate, ScheduleCreateResponse, SchedulesIdsResponse, ScheduleInfoResponse, \
    NextTakingsResponse
...
@schedule_router.post('', response_model=ScheduleCreateResponse)
async def create_schedule(body: ScheduleCreate, db_session: AsyncSession = Depends(get_db_session)):
    ...
    return ScheduleCreateResponse.model_validate(new_schedule, from_attributes=True)
